...
//     const pairLabel = displayPairNumber ?? pair.pairId;
//     addTextLine(`Pair ${pairLabel}`, 13);
...
//           addWrappedText("Explanation: ", issue.explanation, 9);
//         }

//         if (issue.suggested_fix?.trim()) {
//           addWrappedText("Suggestion: ", issue.suggested_fix, 9);
//         }
...
//         if (index < issues.length - 1) {
//           state.y -= 10; // increase/decrease this value to control spacing
//         }
//       });
//     }
